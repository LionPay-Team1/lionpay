...
CREATE UNIQUE INDEX ASYNC IF NOT EXISTS idx_transactions_idempotency ON transactions (idempotency_key);
...
CREATE INDEX ASYNC IF NOT EXISTS idx_exchange_rates_lookup ON exchange_rates (source_currency, target_currency, updated_at);
...
CREATE INDEX ASYNC IF NOT EXISTS idx_exchange_rate_history_rate_id ON exchange_rate_history (exchange_rate_id);
CREATE INDEX ASYNC IF NOT EXISTS idx_exchange_rate_history_currencies ON exchange_rate_history (source_currency, target_currency);
-- Note: Aurora DSQL does not support ASC/DESC in CREATE INDEX ASYNC
CREATE INDEX ASYNC IF NOT EXISTS idx_exchange_rate_history_changed_at ON exchange_rate_history (changed_at);
-- =============================================
-- Seed Data
-- =============================================
-- Currencies
