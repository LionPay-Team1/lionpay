...
public class WalletRepository : IWalletRepository
{
        ...
        NpgsqlTransaction? transaction = null)
    {
        ...
        var connection = transaction?.Connection ?? _dataSource.CreateConnection();
    ...
    public async Task CreateWalletAsync(LionPay.Wallet.Models.Wallet wallet)
    {
        const string sql = @"
            ...
            ON CONFLICT (wallet_id, user_id) DO NOTHING"; // Lazy provisioning can accept getting existing
